package com.example.lab_20220428_example2
...
import com.example.lab_20220428_example2.databinding.ActivityMainBinding
import java.io.File
    ...
    private val onDownloadComplete = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(intent.action)) {
                ...
                Toast.makeText(context, "Motification clicked", Toast.LENGTH_SHORT).show()
            }
        }
    }
